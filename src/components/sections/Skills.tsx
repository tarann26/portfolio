...
const skillCategories: SkillCategory[] = [
  {
    name: "languages",
    skills: [
      { name: "python", context: "SeeCare, noetic, ML work" },
      { name: "typescript", context: "Invoke, Crypto-Tracker, BrainWave" },
      { name: "java", context: "AI agents, academic projects" },
      { name: "c/c++", context: "Systems programming, memory simulators" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "pytorch", context: "SeeCare face embeddings" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "supabase", context: "BrainWave, Crypto-Tracker" },
      { name: "docker", context: "Containerization" },
      { name: "postgresql", context: "All database work" },
      { name: "redis", context: "Caching, Celery" },
    ],
  },
  {
    name: "blockchain",
